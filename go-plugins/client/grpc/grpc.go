...
func (g *grpcClient) call(ctx context.Context, address string, req client.Request, rsp interface{}, opts client.CallOptions) error {
	...
	ctx2, _ := context.WithTimeout(context.Background(), opts.DialTimeout)
	cc, err := g.pool.getConn(ctx2, address, grpc.WithDefaultCallOptions(grpc.CallCustomCodec(cf)), grpc.WithInsecure())
	if err != nil {
	...
	go func() {
		err := cc.cc.Invoke(ctx, methodToGRPC(req.Method(), req.Request()), req.Request(), rsp)
		ch <- microError(err)
	}()
...
func (g *grpcClient) stream(ctx context.Context, address string, req client.Request, opts client.CallOptions) (client.Streamer, error) {
	...
	ctx2, _ := context.WithTimeout(context.Background(), opts.DialTimeout)
	cc, err := grpc.DialContext(ctx2, address, grpc.WithDefaultCallOptions(grpc.CallCustomCodec(cf)), grpc.WithInsecure())
	if err != nil {
...
func (g *grpcClient) Call(ctx context.Context, req client.Request, rsp interface{}, opts ...client.CallOption) error {
	...
	next, err := g.opts.Selector.Select(req.Service()+"-grpc", callOpts.SelectOptions...)
